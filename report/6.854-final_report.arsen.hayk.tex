...
%  \includegraphics[height=5cm]{figures/monotonicity_comparison}
    ...
    \hline
        333333    & 202.0    & 1398.2  \\
    \end{tabular}
    \caption{Runtimes (in millseconds) of Naive and Bokal et. al for point moving in $x$ direction with Gaussian noise.}
    \label{fig:monotonicity_comparison2}
\end{figure}
...
%  \includegraphics[height=5cm]{figures/monotonicity_comparison}
	...
	\hline
	    1000000    & 629.5    & 909.6 
	\end{tabular}
    \caption{Runtimes (in millseconds) of Naive and Bokal et. al for random walk dataset.}
    \label{fig:monotonicity_comparison2}
\end{figure}
...
\hline
    333333    & 2736.9    & 157.3 
\end{tabular}
  \caption{Runtimes (in millseconds) of Naive and Chan, Prat on \textbf{moving point} dataset [Similar to Figure \ref{fig:monotonicity_comparison}}
...
\end{tabular}
  \caption{Runtimes (in millseconds) of Naive and Chan, Prat on \textbf{random walk} dataset [Similar to Figure \ref{fig:monotonicity_comparison}}
  \label{fig:diameter_comparison}
\end{figure}
